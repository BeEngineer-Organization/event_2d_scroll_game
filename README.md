...
- teacherブランチのsampleフォルダ内は生徒へのデモンストレーション用の追加機能を乗せたコード
    - crystal を取得すると、**axe を f キーで投げられる** ようにしています。（アイテムを取得すると見た目が変わります。）
    - 既存の敵に加え、ジャンプしながら spear を投げてくる敵、プレイヤーと同じようにジャンプをしながら axe を投げてくる敵を追加しています。